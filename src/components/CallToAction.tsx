...
const CallToAction = ({ className = "" }: CallToActionProps) => {
  return (
    <div
      className={`bg-gradient-to-r from-brand-600 to-brand-800 text-white rounded-xl py-12 px-8 ${className}`}
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Join businesses that are strategically managing their reviews and
        ...
        >
          <Button
            ...
            asChild
          >
            <Link to="/signup">Get Started – $44.99/month</Link>
          </Button>
        </motion.div>
      </div>
    </div>
