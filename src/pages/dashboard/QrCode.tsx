      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              When customers scan this QR code, they'll be asked to rate their experience
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <Button variant="outline" size="sm" onClick={handleRegenerateQr} disabled={isGenerating}>
            ...
            <Tabs defaultValue="standard" value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="standard" className="mt-4">
                <div className="bg-gray-100 rounded-lg p-4 mb-4 aspect-square flex items-center justify-center">
                  <img src={qrCodeData} alt="Standard QR Code" className="w-2/3 h-2/3" />
                </div>
                <p className="text-sm text-muted-foreground mb-4">
                  Standard QR code perfect for business cards, receipts, or small displays.
                </p>
              </TabsContent>
                ...
                <div className="bg-gray-100 rounded-lg p-4 mb-4 aspect-[4/5] flex items-center justify-center">
                  <div className="bg-white p-6 rounded-lg shadow-sm text-center w-4/5">
                    ...
                    <div className="flex justify-center">
                      <img src={qrCodeData} alt="Table Tent QR Code" className="w-40 h-40" />
                    </div>
                    <p className="text-sm mt-2">Scan to share your experience</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground mb-4">
                  Table tent design perfect for restaurant tables or countertops.
                </p>
              </TabsContent>
              <TabsContent value="poster" className="mt-4">
                <div className="bg-gray-100 rounded-lg p-4 mb-4 aspect-[3/4] flex items-center justify-center">
                  <div className="bg-white p-6 rounded-lg shadow-sm text-center w-4/5">
                    ...
                    <p className="text-sm mb-4">Let us know by leaving a review!</p>
                    <div className="flex justify-center">
                      <img src={qrCodeData} alt="Poster QR Code" className="w-40 h-40" />
                    </div>
